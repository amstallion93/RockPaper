 ...
 */
package com.rockpaper.test.setup;
...
import com.rockpaper.test.constants.RockPaperTestConstants;
import com.rockpaper.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = RockPaperTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/RockPapertest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/RockPapertest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/RockPapertest/import/cstickets.impex");
			...
			importImpexFile(context, "/RockPapertest/import/csquotes.impex");
		}
	}
}
