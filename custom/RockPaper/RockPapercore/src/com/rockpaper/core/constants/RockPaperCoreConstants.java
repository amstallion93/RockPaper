...
/**
 * Global class for all RockPaperCore constants. You can add global constants for your extension into this class.
 */
public final class RockPaperCoreConstants extends GeneratedRockPaperCoreConstants
{
	public static final String EXTENSIONNAME = "RockPapercore";


	private RockPaperCoreConstants()
	{
		//empty
	}
