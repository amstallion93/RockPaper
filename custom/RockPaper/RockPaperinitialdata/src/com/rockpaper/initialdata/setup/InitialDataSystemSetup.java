 ...
 */
package com.rockpaper.initialdata.setup;
...
import com.rockpaper.initialdata.constants.RockPaperInitialDataConstants;


/**
 * This class provides hooks into the system's initialization and update processes.
 */
@SystemSetup(extension = RockPaperInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	final String RockPaper = "RockPaper";
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		importData.setContentCatalogNames(Arrays.asList(RockPaper));
		importData.setProductCatalogName(RockPaper);
		importData.setStoreNames(Arrays.asList(RockPaper));
