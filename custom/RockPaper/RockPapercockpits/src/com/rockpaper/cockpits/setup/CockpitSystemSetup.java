 ...
 */
package com.rockpaper.cockpits.setup;
...
import com.rockpaper.cockpits.constants.RockPaperCockpitsConstants;
 ...
 */
@SystemSetup(extension = RockPaperCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(RockPaperCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(RockPaperCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						RockPaperCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/RockPapercockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
