 ...
 */
package com.rockpaper.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(RockPaperFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(RockPaperFulfilmentProcessConstants.PARENT_PROCESS);
